...
<script src="//dapi.kakao.com/v2/maps/sdk.js?appkey=c5a0ea018dff1e363ea66a6773eba74e"></script>
...
<body>
	<div class="main">
			...
			<div class="Maincontainer">
				<div class="section1_title">
					...
					<ul class="sns">
						...
						<li><a href="https://github.com/ParkSeonDoo?tab=repositories"><i class="xi-github xi-2x"></i></a></li>
					</ul>
				</div>
		...
		<section class="contact-section bg-dark section5">
			<div class="Maincontainer">
				<div class="section6_left">
					...
					<p><span class="subtitle">Name</span><strong>:</strong><span class="subname">박선두</span></p>
					<p><span class="subtitle">Phone</span><strong>:</strong><span class="subname">010-3921-1489</span></p>
					<p><span class="subtitle">E-mail</span><strong>:</strong><span class="subname">psd3812@naver.com</span></p>
					<p><span class="subtitle1">Address</span><strong>:</strong><span class="subname">서울시 강서구</span></p>
		...
		<footer>
			<div class="footer_di">
				<span>© 2022. Park Seon Doo. Copyright.</span>
			</div>
		</footer>
	</div>
